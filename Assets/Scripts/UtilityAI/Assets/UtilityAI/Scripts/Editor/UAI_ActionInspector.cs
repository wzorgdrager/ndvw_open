...
public class UAI_ActionInspector : Editor {  
	...
	private void OnEnable() {
		...
		considerationList.elementHeight = EditorGUIUtility.singleLineHeight * 3 + 5;
		...
		(Rect rect, int index, bool isActive, bool isFocused) => {
            ...
            EditorGUI.LabelField(
                new Rect(rect.width - 134.0f, rect.y + EditorGUIUtility.singleLineHeight * 2 + 2, 100.0f, EditorGUIUtility.singleLineHeight),
                "Enforce non-zero");
            EditorGUI.PropertyField(
                new Rect(rect.x, rect.y + EditorGUIUtility.singleLineHeight * 2 + 2, 50.0f, EditorGUIUtility.singleLineHeight),
                element.FindPropertyRelative("greaterThanZero"), GUIContent.none);
            EditorGUI.PropertyField(
